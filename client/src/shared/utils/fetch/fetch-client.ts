 ...
 * headers - дополнительные заголовки, которые будут включены во все запросы
 * params - параметры поиска, которые будут включены во все запросы
 * options - дополнительные параметры нашего запроса, которые будут включены во все запросы
 */
